...
public class AppUtils {
    ...
    public static boolean isInstallApp(final String action, final String category) {
        ...
        PackageManager pm = Utils.getApp()
                .getPackageManager();
     ...
     */
    public static void installApp(final Activity activity, final String filePath, final String authority,
    ...
    public static void uninstallApp(final String packageName) {
        ...
        Utils.getApp()
                .startActivity(IntentUtils.getUninstallAppIntent(packageName));
    }
    ...
    public static void getAppDetailsSettings() {
        getAppDetailsSettings(Utils.getApp()
                .getPackageName());
    }
    ...
    public static void getAppDetailsSettings(final String packageName) {
        ...
        Utils.getApp()
                .startActivity(IntentUtils.getAppDetailsSettingsIntent(packageName));
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(Utils.getApp()
                .getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(Utils.getApp()
                .getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(Utils.getApp()
                .getPackageName());
    }
    ...
    public static boolean isSystemApp() {
        return isSystemApp(Utils.getApp()
                .getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(Utils.getApp()
                .getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(Utils.getApp()
                .getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(Utils.getApp()
                .getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(Utils.getApp()
                        .getPackageName());
            }
        }
        return false;
     ...
     * 获取未安装的apk的md5签名信息
     *
     * @param apkFile apk存放路径
     * @return 签名md5值
     */
    public static String getUninstallApkSignatureMd5(String apkFile) {
        ...
        try {
            ...
            Field packageInfoFld = pkgParserPkg.getClass()
                    .getDeclaredField("mSignatures");
            Signature[] info = (Signature[]) packageInfoFld.get(pkgParserPkg);
            if (info != null && info.length > 0) {
                return EncryptUtils.encryptMD5ToString(info[0].toByteArray());
            }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(Utils.getApp()
                .getPackageName());
    }
