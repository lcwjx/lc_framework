...
public class ToastUtils {
    ...
    private static int yOffset    = (int) (64 * Utils.getApp()
            .getResources()
    ...
    public static void showShort(@NonNull final CharSequence text) {
        LayoutInflater inflater = (LayoutInflater) Utils.getApp()
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        //自定义布局
        View view = inflater.inflate(R.layout.layout_custom_toast_without_img, null);
        //自定义toast文本
        TextView mTextView = (TextView) view.findViewById(R.id.tv_warning);
        mTextView.setText(text);
        Toast sToast = new Toast(Utils.getApp());
    ...
    public static void showShort(@StringRes final int resId) {
        ...
        //自定义toast文本
        TextView mTextView = (TextView) view.findViewById(R.id.tv_warning);
        mTextView.setText(Utils.getApp()
                .getResources()
                .getText(resId)
                .toString());
        sToast.setDuration(Toast.LENGTH_SHORT);
    ...
    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(Utils.getApp()
                .getResources()
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                ...
                TextView tvMessage = (TextView) sToast.getView()
    ...
    public static void showCusToast(Context context, @NonNull final CharSequence msg) {
        ...
        sToast.setGravity(Gravity.CENTER, 0, (int) -(outMetrics.heightPixels * 0.07));
        sToast.setDuration(Toast.LENGTH_SHORT);
        sToast.setView(view);
        sToast.show();
    }

    private static void dealToast(int layout) {
    ...
    public static void showSimpleCenterToast(Context context, final int msg) {
    ...
    public static void showCusToast(Context context, final int msg) {
